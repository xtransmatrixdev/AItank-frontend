...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[30vh] sm:h-[40vh] md:h-[60vh] lg:h-[70vh] overflow-hidden bg-[#12131C]">
      <video
        ref={videoRef}
        autoPlay
        loop
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-[#12131C] mix-blend-multiply flex items-center justify-center py-2 sm:py-4 md:py-0 bg-[#12131C]">
        <h1
